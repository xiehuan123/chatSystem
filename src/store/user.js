...
export const userStore = defineStore("user", () => {
  ...
  return { $socket,user,token,sesstionList,clearCuurentSesstion,sesstionMsgs,initInfoList,noticeCount, openSocket, cuurentSesstion,setSesstionreadStaus,setUser ,setToken,setCuurentSesstion,clearUser,setInfoList}
})
