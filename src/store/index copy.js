...
export const userStore = defineStore("user", () => {
  ...
  return { $socket,user,peer,callType,token,localUser, remoteUser,remoterCall,locahostCall,infoList,conn, openSocket,setConnect, cuurentSesstion,setSesstionreadStaus,setUser ,setToken,setCuurentSesstion,clearUser,cancelMediaStream,setInfoList}
})
